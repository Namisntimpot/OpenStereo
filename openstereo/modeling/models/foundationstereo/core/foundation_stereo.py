...
from openstereo.modeling.models.foundationstereo.core.update import *
from openstereo.modeling.models.foundationstereo.core.extractor import *
from openstereo.modeling.models.foundationstereo.core.geometry import Combined_Geo_Encoding_Volume
from openstereo.modeling.models.foundationstereo.core.submodule import *
from openstereo.modeling.models.foundationstereo.core.utils.utils import *
from openstereo.modeling.models.foundationstereo.Utils import *
...
class FoundationStereo(nn.Module, huggingface_hub.PyTorchModelHubMixin):
    def __init__(self, args):
        super().__init__()
        self.args = args
        # to support bfloat16 precision, by Qian Zhou
        precision_dtype = str(self.args.get("precision_dtype", "fp16")).lower()
        self.precision_dtype = torch.bfloat16 if precision_dtype in ["bf16", "bfloat16"] else torch.float16
    ...
    def upsample_disp(self, disp, mask_feat_4, stem_2x):
        ...
        with autocast(enabled=self.args.mixed_precision, dtype=self.precision_dtype):
